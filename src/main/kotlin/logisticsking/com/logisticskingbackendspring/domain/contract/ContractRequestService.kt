...
class ContractRequestService(
    ...
    override fun create(command: CreateContractRequestCommand): ContractRequestResult {
        ...
        val contractRequest = ContractRequest.create(
            ...
            pickupDateFrom = command.pickupDateFrom,
            pickupDateTo = command.pickupDateTo,
            deliveryDateFrom = command.deliveryDateFrom,
            deliveryDateTo = command.deliveryDateTo,
            recurringPickupCycle = command.recurringPickupCycle,
            recurringPickupDaysOfWeek = command.recurringPickupDaysOfWeek,
            recurringPickupDayOfMonth = command.recurringPickupDayOfMonth,
