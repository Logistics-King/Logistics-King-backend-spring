...
VALUES
    ...
    ('/api/v1/agencies', 'GET', '["ADMIN","VENDOR","DRIVER"]', '화주는 계약 요청 대상 대리점을 조회하고, 배송기사는 프로필 등록 시 소속 대리점을 검색합니다.', NOW(6), NOW(6)),
    ('/api/v1/agencies/{agencyId}', 'GET', '["ADMIN","VENDOR","DRIVER"]', '화주와 배송기사가 대리점 대표자명, 연락처, 주소, 서비스 조건 등 상세 정보를 조회합니다.', NOW(6), NOW(6)),
