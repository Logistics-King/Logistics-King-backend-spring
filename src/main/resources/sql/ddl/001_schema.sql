...
CREATE TABLE IF NOT EXISTS contract_requests (
    ...
    contract_type VARCHAR(30) NOT NULL DEFAULT 'SINGLE',
    pickup_date_from DATE NULL,
    pickup_date_to DATE NULL,
    delivery_date_from DATE NULL,
    delivery_date_to DATE NULL,
    recurring_pickup_cycle VARCHAR(30) NULL,
    recurring_pickup_days_of_week VARCHAR(100) NULL,
    recurring_pickup_day_of_month INT NULL,
